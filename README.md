...
FastAI - приложение для генерации простых одностраничных сайтов-визиток с помощью ИИ. При этом пользователю достаточно лишь ввести краткое текстовое описание сайта.

Приложение использует сервисы [DeepSeek](https://deepseek.com/) и [Unsplash](https://unsplash.com/)
